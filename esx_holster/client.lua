...
RegisterCommand("holster", function(source, args, raw)
    ...
    if args[1] == '0' then
		holster = 0
		ESX.ShowNotification('Kein Holster')
	-- Chain 8
    elseif args[1] == '1' then
		holster = 1
		ESX.ShowNotification('Du hast dir denn Holster Chain 8')
	-- Chain 6
    elseif args[1] == '2' then
		holster = 2
		ESX.ShowNotification('Du hast dir denn Holster Chain 6')
	-- T-shirt 15
    elseif args[1] == '3' then
		holster = 3
		ESX.ShowNotification('Du hast dir denn Holster T-Shirt 15')
